...
GRANT DELETE ON api_key_quota_policies, api_key_scopes, api_key_space_grants, document_chunks, document_files, knowledge_items, space_memberships TO gateway_runtime;
...
GRANT SELECT ON document_revision_chunks, document_revisions, documents, embedding_generations, ingestion_jobs, job_outbox, members, operational_alerts, retrieval_units, space_memberships, webhook_deliveries, webhook_subscriptions, workspaces TO gateway_worker;
